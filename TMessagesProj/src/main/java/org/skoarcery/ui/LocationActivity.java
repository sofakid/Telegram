...
// import com.google.android.gms.maps.AmazonMap;
...
import org.skoarcery.firegram.LocationController;
...
import org.skoarcery.ui.Adapters.BaseLocationAdapter;
import org.skoarcery.ui.Adapters.LocationActivityAdapter;
import org.skoarcery.ui.Adapters.LocationActivitySearchAdapter;
import org.skoarcery.ui.Cells.GraySectionCell;
import org.skoarcery.ui.Cells.LocationCell;
import org.skoarcery.ui.Cells.LocationLoadingCell;
import org.skoarcery.ui.Cells.LocationPoweredCell;
import org.skoarcery.ui.Cells.SendLocationCell;
...
import org.skoarcery.ui.Components.MapPlaceholderDrawable;
...
public class LocationActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
        ...
        actionBar.setActionBarMenuOnItemClick(new ActionBar.ActionBarMenuOnItemClick() {
            ...
            public void onItemClick(int id) {
                if (id == -1) {
                    ...
                    if (googleMap != null) {
                        googleMap.setMapType(AmazonMap.MAP_TYPE_NORMAL);
                    }
                } else if (id == map_list_menu_satellite) {
                    if (googleMap != null) {
                        googleMap.setMapType(AmazonMap.MAP_TYPE_SATELLITE);
                    }
                } else if (id == map_list_menu_hybrid) {
                    if (googleMap != null) {
                        googleMap.setMapType(AmazonMap.MAP_TYPE_HYBRID);
                    }
                } else if (id == share) {
                    try {
    ...
    private void onMapInit() {
        ...
        googleMap.setOnMyLocationChangeListener(new AmazonMap.OnMyLocationChangeListener() {
            @Override
