...
import org.skoarcery.firegram.AndroidUtilities;
import org.skoarcery.PhoneFormat.PhoneFormat;
import org.skoarcery.firegram.BuildConfig;
import org.skoarcery.firegram.BuildVars;
import org.skoarcery.firegram.ChatObject;
import org.skoarcery.firegram.DataQuery;
import org.skoarcery.firegram.DownloadController;
import org.skoarcery.firegram.Emoji;
import org.skoarcery.firegram.EmojiSuggestion;
import org.skoarcery.firegram.LocaleController;
import org.skoarcery.firegram.MediaController;
import org.skoarcery.firegram.MessagesStorage;
import org.skoarcery.firegram.NotificationsController;
import org.skoarcery.firegram.SecretChatHelper;
import org.skoarcery.firegram.SendMessagesHelper;
import org.skoarcery.firegram.SharedConfig;
import org.skoarcery.firegram.UserObject;
import org.skoarcery.firegram.Utilities;
import org.skoarcery.firegram.VideoEditedInfo;
import org.skoarcery.firegram.browser.Browser;
import org.skoarcery.firegram.support.SparseLongArray;
import org.skoarcery.firegram.support.widget.GridLayoutManager;
import org.skoarcery.firegram.support.widget.GridLayoutManagerFixed;
import org.skoarcery.firegram.support.widget.LinearLayoutManager;
import org.skoarcery.firegram.support.widget.LinearSmoothScrollerMiddle;
import org.skoarcery.firegram.support.widget.RecyclerView;
import org.skoarcery.firegram.ApplicationLoader;
import org.skoarcery.firegram.FileLoader;
import org.skoarcery.tgnet.ConnectionsManager;
import org.skoarcery.tgnet.TLRPC;
import org.skoarcery.firegram.ContactsController;
import org.skoarcery.firegram.FileLog;
import org.skoarcery.firegram.MessageObject;
import org.skoarcery.firegram.MessagesController;
import org.skoarcery.firegram.NotificationCenter;
import org.skoarcery.firegram.R;
import org.skoarcery.firegram.UserConfig;
import org.skoarcery.ui.ActionBar.ActionBarLayout;
import org.skoarcery.ui.ActionBar.AlertDialog;
import org.skoarcery.ui.ActionBar.BackDrawable;
import org.skoarcery.ui.ActionBar.BottomSheet;
import org.skoarcery.ui.ActionBar.SimpleTextView;
import org.skoarcery.ui.ActionBar.ThemeDescription;
import org.skoarcery.ui.Adapters.MentionsAdapter;
import org.skoarcery.ui.Adapters.StickersAdapter;
import org.skoarcery.ui.Cells.BotSwitchCell;
import org.skoarcery.ui.Cells.ChatActionCell;
import org.skoarcery.ui.Cells.ChatLoadingCell;
import org.skoarcery.ui.ActionBar.ActionBar;
import org.skoarcery.ui.ActionBar.ActionBarMenu;
import org.skoarcery.ui.ActionBar.ActionBarMenuItem;
import org.skoarcery.ui.Cells.ChatMessageCell;
import org.skoarcery.ui.Cells.ChatUnreadCell;
import org.skoarcery.ui.Cells.CheckBoxCell;
import org.skoarcery.ui.Cells.ContextLinkCell;
import org.skoarcery.ui.Cells.MentionCell;
import org.skoarcery.ui.Cells.StickerCell;
import org.skoarcery.ui.Components.AlertsCreator;
import org.skoarcery.ui.Components.BackupImageView;
import org.skoarcery.ui.ActionBar.BaseFragment;
import org.skoarcery.ui.Cells.BotHelpCell;
import org.skoarcery.ui.Components.ChatActivityEnterView;
import org.skoarcery.firegram.ImageReceiver;
import org.skoarcery.ui.Components.ChatAttachAlert;
import org.skoarcery.ui.Components.ChatAvatarContainer;
import org.skoarcery.ui.Components.ChatBigEmptyView;
import org.skoarcery.ui.Components.CombinedDrawable;
import org.skoarcery.ui.Components.CorrectlyMeasuringTextView;
import org.skoarcery.ui.Components.EmbedBottomSheet;
import org.skoarcery.ui.Components.EmojiView;
import org.skoarcery.ui.Components.ExtendedGridLayoutManager;
import org.skoarcery.ui.Components.FragmentContextView;
import org.skoarcery.ui.Components.InstantCameraView;
import org.skoarcery.ui.Components.LayoutHelper;
import org.skoarcery.ui.Components.NumberTextView;
import org.skoarcery.ui.Components.PipRoundVideoView;
import org.skoarcery.ui.Components.RadialProgressView;
import org.skoarcery.ui.Components.RecyclerListView;
import org.skoarcery.ui.Components.ShareAlert;
import org.skoarcery.ui.Components.Size;
import org.skoarcery.ui.Components.SizeNotifierFrameLayout;
import org.skoarcery.ui.Components.StickersAlert;
import org.skoarcery.ui.ActionBar.Theme;
import org.skoarcery.ui.Components.TypefaceSpan;
import org.skoarcery.ui.Components.URLSpanBotCommand;
import org.skoarcery.ui.Components.URLSpanMono;
import org.skoarcery.ui.Components.URLSpanNoUnderline;
import org.skoarcery.ui.Components.URLSpanReplacement;
import org.skoarcery.ui.Components.URLSpanUserMention;
import org.skoarcery.ui.Components.voip.VoIPHelper;
                ...
                chatMessageCell.setDelegate(new ChatMessageCell.ChatMessageCellDelegate() {
                    ...
                    public void didPressedImage(ChatMessageCell cell) {
                        ...
                        if (message.needDrawBluredPreview()) {
                            ...
                            FileLog.d("CHAT ACTIVITY :: didPressedImage :: message_type == 4");
                            if (!AndroidUtilities.isGoogleMapsInstalled(ChatActivity.this)) {
                                return;
                            }
                    ...
                    if ((index = animatingMessageObjects.indexOf(message)) != -1) {
                        ...
                        messageCell.getViewTreeObserver().addOnPreDrawListener(new ViewTreeObserver.OnPreDrawListener() {
                            ...
                            public boolean onPreDraw() {
                                ...
                                org.skoarcery.ui.Components.Rect rect = instantCameraView.getCameraRect();
