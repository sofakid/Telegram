...
package org.skoarcery.firegram;
...
import org.skoarcery.ui.Components.ForegroundDetector;
...
public class AndroidUtilities {
    ...
    public static boolean isGoogleMapsInstalled(final BaseFragment fragment) {
        return AmazonMapsRuntimeUtil.isAmazonMapsRuntimeAvailable(ApplicationLoader.applicationContext) == ConnectionResult.SUCCESS;
    }
    
    //public static boolean isGoogleMapsInstalled(final BaseFragment fragment) {
    //    return AmazonMapsRuntimeUtil.isAmazonMapsRuntimeAvailable(fragment) == ConnectionResult.SUCCESS;
        /*
        try {
    ...
    private static File getAlbumDir() {
        ...
        if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())) {
            storageDir = new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES), "Firegram");
