...
static const char *FileLoadOperationClassPathName = "org/skoarcery/tgnet/FileLoadOperation";
...
static const char *NativeByteBufferClassPathName = "org/skoarcery/tgnet/NativeByteBuffer";
...
static const char *ConnectionsManagerClassPathName = "org/skoarcery/tgnet/ConnectionsManager";
static JNINativeMethod ConnectionsManagerMethods[] = {
        ...
        {"native_sendRequest", "(IJLorg/skoarcery/tgnet/RequestDelegateInternal;Lorg/skoarcery/tgnet/QuickAckDelegate;Lorg/skoarcery/tgnet/WriteToSocketDelegate;IIIZI)V", (void *) sendRequest},
        ...
        {"native_checkProxy", "(ILjava/lang/String;ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Lorg/skoarcery/tgnet/RequestTimeDelegate;)J", (void *) checkProxy}
};
...
extern "C" int registerNativeTgNetFunctions(JavaVM *vm, JNIEnv *env) {
    ...
    jclass_RequestDelegateInternal = (jclass) env->NewGlobalRef(env->FindClass("org/skoarcery/tgnet/RequestDelegateInternal"));
    ...
    jclass_RequestTimeDelegate = (jclass) env->NewGlobalRef(env->FindClass("org/skoarcery/tgnet/RequestTimeDelegate"));
    ...
    jclass_QuickAckDelegate = (jclass) env->NewGlobalRef(env->FindClass("org/skoarcery/tgnet/QuickAckDelegate"));
    if (jclass_RequestDelegateInternal == 0) {
        return JNI_FALSE;
    }
    ...
    jclass_WriteToSocketDelegate = (jclass) env->NewGlobalRef(env->FindClass("org/skoarcery/tgnet/WriteToSocketDelegate"));
    ...
    jclass_FileLoadOperationDelegate = (jclass) env->NewGlobalRef(env->FindClass("org/skoarcery/tgnet/FileLoadOperationDelegate"));
    ...
    jclass_ConnectionsManager = (jclass) env->NewGlobalRef(env->FindClass("org/skoarcery/tgnet/ConnectionsManager"));
